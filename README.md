...
I’m developing **PGX**, a lightweight natural-language format for making meaning addressable in LLM conversations and documents. PGX sits between ordinary language and graph practice: it lets people and LLMs name point at ideas, connect them, cite them, and reuse them while staying close to the way writing, thinking, and conversation actually work. 

I’m also building **[Parmesan](https://github.com/jacksenpierce/parmesan)**, a local, SQLite-backed tool for durable structured work with LLMs. The goal is simple: open a conversation, bring in your material, and develop a knowledge structure that can survive the chat.
...
**Start with [Parmesan](https://github.com/jacksenpierce/parmesan).**
